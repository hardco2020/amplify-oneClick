...
TABLE_NAME = "ppaModel-" + os.environ["ENV"]
...
def handler(event, context):
    ...
    try:
        ...
        training_image = (
            account_id
            + ".dkr.ecr.ap-southeast-1.amazonaws.com/gary-yolov5-train:latest"
        )
        ...
        role_arn = boto3.client("ssm").get_parameter(Name="/ppe/config/arn")[
            "Parameter"
        ]["Value"]
